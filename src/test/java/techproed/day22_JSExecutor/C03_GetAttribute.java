...
public class C03_GetAttribute extends TestBase {
    ...
    public void test01() {
       ...
       // WebElement date = (WebElement) js.executeScript("return document.querySelector(\"input[id='checkin_date']\")");
        /*
        Java Script kodlarıyla yazılmış webelementleri bizim bildiğimiz findElement()
        methoduyla locate edemeyebiliriz.
        js executor kullanarak ister html ister java script ile yazılmış olsun bir
        webelementin locate ini js executor ile alabiliriz.
        Yukarıdaki örnekte sayfadaki tarih webelementini js executor ile locate ettik.
         */
        date.clear();
        date.sendKeys("5/25/2023");

        //  Date webelementinin attribute değerlerini yazdırınız
        ...
        System.out.println("ID Attribute Değeri = " + idAttributeDegeri);
        System.out.println("Type Attribute Değeri = " + typeAttributeDegeri);
        System.out.println("Name Attribute Değeri = " + nameAttributeDegeri);
        System.out.println("Value Attribute Değeri = " + valueAttributeDegeri);
        /*
        Js executor ile attribute değerlerini yazdırabilmek için js ile locate ettiğimiz
        webelementin sonuna yukarıdaki örnekteki gibi hangi attribute değerini
        yazdırmak istersek sonuna attribute adını yazarız
         */
