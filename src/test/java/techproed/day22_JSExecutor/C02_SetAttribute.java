...
public class C02_SetAttribute extends TestBase {
    ...
    public void test03() {
        ...
        Sayfadaki arama kutusunu locate edip arama kutusunun value attribute ne
        'QA' değerini atarız
         */
        WebElement aramaKutusu = driver.findElement(By.xpath("//*[@type='search']"));
        JavascriptExecutor js= (JavascriptExecutor) driver;
    ...
    public void test04() {
        ...
        WebElement aramaKutusu = driver.findElement(By.xpath("//*[@type='search']"));
        JavascriptExecutor js= (JavascriptExecutor) driver;
        js.executeScript("arguments[0].setAttribute('id','ılyas')",aramaKutusu);
        //-->elementor-search-form-9f26725 normalde id attribute degeri
        driver.findElement(By.id("ılyas")).sendKeys("Java", Keys.ENTER);
    ...
    public void test05() {
       ...
       //Method ile attribute değerini set ettik.
    }
}
