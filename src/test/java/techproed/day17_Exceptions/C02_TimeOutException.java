...
public class C02_TimeOutException extends TestBase {
    /*
    TIME OUT EXCEPTION
        -Expilict wait kullanırken yanlış method ya da yanlış max bekleme süresi
        gibi durumlarda org.openqa.selenium.TimeoutException hatası alırız
     */
    ...
    public void test01() {
        ...
        org.openqa.selenium.TimeoutException normalde helloWorldText web elementi
        5-6 saniye civarında etkileşime girerken biz max bekleme süresini 2
        saniye verdiğimiz için bu hatayı aldık dolayısıyla bu exception ı
        handle edebilmek için doğru süreyi ve doğru methodu kullanmamız gerekir
         */
    ...
    public void test02() {
        ...
        */
        ...
        Yukarıdaki örnekte max süreyi doğru vermemize rağmen yanlış locate aldığımız
        için yine   org.openqa.selenium.TimeoutException hatası alırız.Dolayısıyla
        bu exception'ı handle edebilmek için locate i doğru almalıyız
         */
